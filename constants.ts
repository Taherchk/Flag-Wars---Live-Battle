...
export const COUNTRIES: Country[] = [
  ...
  { code: 'cd', name: 'DR Congo' }, { code: 'ck', name: 'Cook Islands' }, { code: 'cr', name: 'Costa Rica' },
  ...
  { code: 'ru', name: 'Russia' }, { code: 'rw', name: 'Rwanda' }, { code: 'ws', name: 'Samoa' },
  { code: 'sm', name: 'San Marino' }, { code: 'sa', name: 'Saudi Arabia' }, { code: 'sn', name: 'Senegal' },
  ...
  { code: 'gb', name: 'UK' }, { code: 'us', name: 'USA' }, { code: 'uy', name: 'Uruguay' },
  { code: 'uz', name: 'Uzbekistan' }, { code: 'vu', name: 'Vanuatu' }, { code: 've', name: 'Venezuela' },
  { code: 'vn', name: 'Vietnam' }, { code: 'wf', name: 'Wallis and Futuna' }, { code: 'ye', name: 'Yemen' },
  { code: 'zm', name: 'Zambia' }, { code: 'zw', name: 'Zimbabwe' }
];

export const RING_RADIUS = 300;
export const MARBLE_RADIUS = 8; // মার্বেল সংখ্যা বেশি হওয়ায় সাইজ সামান্য কমানো হয়েছে
export const GAP_SIZE = 0.55;
